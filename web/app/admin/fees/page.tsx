...
import { FeeStructureBuilder } from '@/app/bursar/fee-structures/fee-structure-builder';
import type { TermOption } from '@/app/bursar/fee-structures/page';
...
export default async function AdminFeesPage({
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Fee Structure"
        description="Define what each class pays this term, then generate invoices. Same as the Bursar view — Admin has full access."
      />
      <FeeStructureBuilder
        classes={classes}
        terms={terms}
